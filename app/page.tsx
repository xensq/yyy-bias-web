...
export default function Landing() {
  ...
  return (
    <div style={{ position: "relative", width: "100vw", height: "100vh", background: "#080810", overflow: "hidden" }}>
      <canvas ref={canvasRef} style={{ position: "absolute", inset: 0 }} />

      {/* Orbital reticle */}<div style={{position:"absolute",right:"8vw",top:"50%",transform:"translateY(-50%)",width:"320px",height:"320px",zIndex:5,pointerEvents:"none"}}><svg width="320" height="320" viewBox="0 0 320 320"><style>{`@keyframes orb1{from{transform:rotate(0deg)}to{transform:rotate(360deg)}}@keyframes orb2{from{transform:rotate(0deg)}to{transform:rotate(-360deg)}}@keyframes orb3{from{transform:rotate(45deg)}to{transform:rotate(405deg)}}@keyframes cp{0%,100%{opacity:0.3;r:4}50%{opacity:1;r:7}}.r1{transform-origin:160px 160px;animation:orb1 14s linear infinite}.r2{transform-origin:160px 160px;animation:orb2 20s linear infinite}.r3{transform-origin:160px 160px;animation:orb3 9s linear infinite}`}</style><circle cx="160" cy="160" r="130" fill="none" stroke="rgba(0,200,150,0.06)" strokeWidth="0.5"/><circle cx="160" cy="160" r="100" fill="none" stroke="rgba(0,200,150,0.08)" strokeWidth="0.5"/><circle cx="160" cy="160" r="60" fill="none" stroke="rgba(0,200,150,0.1)" strokeWidth="0.5"/><circle cx="160" cy="160" r="28" fill="none" stroke="rgba(0,200,150,0.15)" strokeWidth="0.5"/><line x1="160" y1="20" x2="160" y2="75" stroke="rgba(0,200,150,0.1)" strokeWidth="0.5"/><line x1="160" y1="245" x2="160" y2="300" stroke="rgba(0,200,150,0.1)" strokeWidth="0.5"/><line x1="20" y1="160" x2="75" y2="160" stroke="rgba(0,200,150,0.1)" strokeWidth="0.5"/><line x1="245" y1="160" x2="300" y2="160" stroke="rgba(0,200,150,0.1)" strokeWidth="0.5"/><g className="r1"><ellipse cx="160" cy="160" rx="130" ry="42" fill="none" stroke="rgba(0,200,150,0.18)" strokeWidth="0.8" transform="rotate(-15 160 160)"/><circle cx="290" cy="160" r="3" fill="#00c896" opacity="0.85" transform="rotate(-15 160 160)"/></g><g className="r2"><ellipse cx="160" cy="160" rx="100" ry="32" fill="none" stroke="rgba(0,200,150,0.12)" strokeWidth="0.6" transform="rotate(35 160 160)"/><circle cx="260" cy="160" r="2.5" fill="#00c896" opacity="0.6" transform="rotate(35 160 160)"/></g><g className="r3"><ellipse cx="160" cy="160" rx="60" ry="18" fill="none" stroke="rgba(0,200,150,0.22)" strokeWidth="0.6" transform="rotate(65 160 160)"/><circle cx="220" cy="160" r="2" fill="#00c896" opacity="0.9" transform="rotate(65 160 160)"/></g><circle cx="160" cy="160" r="4" fill="#00c896" style={{animation:"cp 2.5s ease-in-out infinite"}}/><circle cx="160" cy="160" r="11" fill="none" stroke="rgba(0,200,150,0.25)" strokeWidth="0.5"/></svg></div>      {/* Orbital */}
      <div style={{position:"absolute",right:"8vw",top:"50%",transform:"translateY(-50%)",width:"320px",height:"320px",zIndex:5,pointerEvents:"none"}}>
        <svg width="320" height="320" viewBox="0 0 320 320">
          <circle cx="160" cy="160" r="130" fill="none" stroke="rgba(0,200,150,0.06)" strokeWidth="0.5"/>
          <circle cx="160" cy="160" r="100" fill="none" stroke="rgba(0,200,150,0.08)" strokeWidth="0.5"/>
          <circle cx="160" cy="160" r="60" fill="none" stroke="rgba(0,200,150,0.1)" strokeWidth="0.5"/>
          <circle cx="160" cy="160" r="11" fill="none" stroke="rgba(0,200,150,0.25)" strokeWidth="0.5"/>
          <circle cx="160" cy="160" r="4" fill="#00c896"/>
        </svg>
      </div>
{/* left edge accent line */}
      ...
      <div style={{ position: "absolute", top: 0, left: 0, right: 0, padding: "20px 32px", display: "flex", justifyContent: "space-between", alignItems: "center", zIndex: 10 }}>
        <span style={{ fontSize: "10px", letterSpacing: "0.4em", color: "rgba(0,200,150,0.4)", fontFamily: "JetBrains Mono, monospace", textTransform: "uppercase" }}>
          yyy research
        </span>
      ...
      <div style={{ position: "relative", zIndex: 10, height: "100%", display: "flex", flexDirection: "column", justifyContent: "center", padding: "0 10vw" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "24px" }}>
          ...
          <span style={{ fontSize: "10px", color: "rgba(0,200,150,0.25)", fontFamily: "JetBrains Mono, monospace", letterSpacing: "0.1em" }}>
      ...
      <div style={{ position: "absolute", bottom: "28px", right: "32px", display: "flex", alignItems: "center", gap: "8px", zIndex: 10 }}>
        ...
        <span style={{ fontSize: "9px", letterSpacing: "0.2em", color: "rgba(0,200,150,0.35)", fontFamily: "JetBrains Mono, monospace", textTransform: "uppercase" }}>live</span>
      </div>
    </div>
  )
}
